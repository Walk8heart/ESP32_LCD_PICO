...
void ui_theme_set(void) {
    ...
    ui.src_1_style .body.grad_color = lv_color_hex(ui.ui_theme.font_rel_color); //LV_COLOR_MAKE(0x26, 0x26, 0x26);
	ui.src_1_style .body.main_color = lv_color_hex(ui.ui_theme.font_rel_color); //LV_COLOR_MAKE(0x26, 0x26, 0x26);
    /*********************************************************************************************/
